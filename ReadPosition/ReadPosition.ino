...
uint16_t remote_id = 0x1122;                            // set this to the ID of the remote device
...
uint16_t anchors[num_anchors] = {0x110a, 0x113f, 0x1248, 0x125e};     // the network id of the anchors: change these to the network ids of your anchors.
int32_t anchors_x[num_anchors] = {0, 0, 5895, 5895};               // anchor x-coorindates in mm
int32_t anchors_y[num_anchors] = {0, 9118, 0, 9118};                  // anchor y-coordinates in mm
int32_t heights[num_anchors] = {1359, 445, 1689, 2171};              // anchor z-coordinates in mm
