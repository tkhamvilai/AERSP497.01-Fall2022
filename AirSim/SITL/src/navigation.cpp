...
void Navigation::use_truth( const true_state_t& truth)
{
  this->s( 0 ) = truth.orientation( 0 );
  this->s( 1 ) = truth.orientation( 1 );
  this->s( 2 ) = truth.orientation( 2 );
  this->s( 3 ) = truth.orientation( 3 );
  this->s( 4 ) = truth.position( 0 );
  this->s( 5 ) = truth.position( 1 );
  this->s( 6 ) = truth.position( 2 );
  this->s( 7 ) = truth.linear_velocity( 0 );
  this->s( 8 ) = truth.linear_velocity( 1 );
  this->s( 9 ) = truth.linear_velocity( 2 );
}
