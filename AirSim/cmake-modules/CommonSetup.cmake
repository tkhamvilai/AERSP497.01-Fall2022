...
macro(AddExecutableSource)
    ...
    file(GLOB_RECURSE PROJECT_CPP "${AIRSIM_ROOT}/${PROJECT_NAME}/src/*.cpp")
	file(GLOB_RECURSE PROJECT_H "${AIRSIM_ROOT}/${PROJECT_NAME}/include/*.h")
    add_executable(${PROJECT_NAME} ${PROJECT_CPP} ${PROJECT_H})
...
macro(CommonSetup)
    ...
    set(RPC_LIB_INCLUDES " ${AIRSIM_ROOT}/rpclib/${RPCLIB_VERSION_FOLDER}/include")
    ...
    ELSE()
        ...
        elseif("${BUILD_TYPE}" STREQUAL "release")
		  ...
		  message("Build ${PROJECT_NAME} as Debug '-D CMAKE_BUILD_TYPE=Debug' by default")
		  set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /D_DEBUG /MDd /RTC1 /Gm /Od ")
        endif()
    ENDIF()
